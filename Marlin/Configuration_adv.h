...
#define LCD_TIMEOUT_TO_STATUS 30000 //Stuart default is 15000
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT 180        // Turn off nozzle if user doesn't change filament within this time limit in seconds //Stuart Default is 45 Seconds
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_6 "Preheat for PETG" //Stuart added item
  #define USER_GCODE_6 "M140 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) //Stuart added item
